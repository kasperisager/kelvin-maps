 ...
 *
 * <p>
 * This class implements {@link HashResolver}, which contains methods for solving hash
 * collisions. LinearProbe implements these methods for the different primitive types
 * and Objects of {@code key} and {@code keys[]}, respectively {@code int, long, float, double and Object}.
 *
 *
 *
